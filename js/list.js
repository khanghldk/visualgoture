...
$('#title-LL').click(function () {
    ...
    // $("#title-LL").text('Linked List');
    title.innerHTML = "Linked List";
    note.innerHTML = '<h1>Linked List</h1><br/>';
    note.innerHTML += "<div>A linked list is a sequence of data structures, which are connected together via links.\n" +
